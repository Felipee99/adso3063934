...
<tr @if ($pet->id % 2 == 0) class="bg-[#0006]"@endif>
    ...
    <td class="hidden md:table-cell">{{ $pet->age }} years</td>
    ...
    <td>
        ...
        <a class="btn btn-outline btn-error btn-xs btn-delete"
            href="javascript:;" data-fullname="{{ $pet->name }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="currentColor" viewBox="0 0 256 256">
                <path d="M216,48H176V40a24,24,0,0,0-24-24H104A24,24,0,0,0,80,40v8H40a8,8,0,0,0,0,16h8V208a16,16,0,0,0,16,16H192a16,16,0,0,0,16-16V64h8a8,8,0,0,0,0-16ZM96,40a8,8,0,0,1,8-8h48a8,8,0,0,1,8,8v8H96Zm96,168H64V64H192ZM112,104v64a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Zm48,0v64a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Z"></path>
            </svg>
        </a>

        <form class="hidden" id="deleteForm{{ $pet->id }}"
            action="{{ url('pets/' . $pet->id) }}" method="POST">
            @csrf
            @method('delete')
        </form>
    </td>
...
@empty
<tr class="bg-[#0009]">
    <td colspan="11" class="text-center text-lg font-bold my-4">
        No results found!
    </td>
</tr>
@endforelse
...
<tr class="bg-[#0009]">
    <td colspan="11">{{ $pets->links('layouts.pagination') }}</td>
</tr>
