    ...
    <div class="w-full md:w-[720px] w-[320px]">
        <form method="POST" action="{{ url('users') }}" class="flex flex-col md:flex-row gap-4 mt-4" enctype="multipart/form-data">
            ...
            <div class="w-full md:w-[320px]">
                <div class="avatar flex flex-col cursor-pointer gap-1 hover:scale-110 transition ease-in justify-center items-center">
                    <div id="upload" class="mask mask-squircle w-48">
                        <img id="preview" src="{{ asset('images/admin.png') }}" />
                    </div>
                    <small class="pb-0 border-white border-b flex text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="#fff" viewBox="0 0 256 256"><path d="M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32Zm0,176H48V48H208ZM90.34,125.66a8,8,0,0,1,0-11.32l32-32a8,8,0,0,1,11.32,0l32,32a8,8,0,0,1-11.32,11.32L136,107.31V168a8,8,0,0,1-16,0V107.31l-18.34,18.35A8,8,0,0,1,90.34,125.66Z"></path></svg>
                        Upload Photo
                    </small>
                    @error('photo')
            ...
            <div class="w-full md:w-[320px]">
                ...
                <button class="btn btn-outline btn-success hover:text-white mt-4 w-full">Add</button>
            </div>
        </form>
    </div>
@endsection
